package com.projects.ofirbarzilay.androidlove.adapter;
...
import com.projects.ofirbarzilay.androidlove.parser.EdNewsHandler.NewsItem;
import com.projects.ofirbarzilay.androidlove.R;

import java.util.ArrayList;

public class EdNewsAdapter extends ArrayAdapter<NewsItem> {
	
	private ArrayList<NewsItem> newsItemList = new ArrayList<NewsItem>();
